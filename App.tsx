...
import { flattenObject, unflattenObject, saveToLocal, loadFromLocal } from './utils';
        ...
        {!activeProject ? (
          ...
          <>
            ...
            <div className="flex-1 overflow-hidden flex flex-col bg-slate-50/20">
              <div className="px-6 lg:px-12 py-4 lg:py-6 bg-white border-b border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 sticky top-0 z-10">
              ...
              <div className="flex-1 overflow-auto p-4 lg:p-12">
                {filteredRows.length === 0 ? (
                  ...
                  <div className="space-y-6 lg:space-y-0 lg:bg-white lg:border lg:border-slate-200 lg:rounded-[3rem] lg:shadow-sm lg:overflow-hidden min-w-full">
                    ...
                    <div className="divide-y divide-slate-100 space-y-6 lg:space-y-0">
                      <Virtuoso
                        style={{ height: '600px' }}
                        data={filteredRows}
                        itemContent={ (_,row) => (
